...
Sound::Sound(uint32_t sample_rate) : buffer_id(0),
                                     source_id(0),
...
GeneratedSound::GeneratedSound(float seconds, float volume,
    uint32_t sample_rate) : Sound(sample_rate),
                            seconds(seconds),
                            volume(volume) {
...
FrontTriangleWave::FrontTriangleWave(float frequency, float seconds,
    float volume, uint32_t sample_rate) : GeneratedSound(seconds, volume, sample_rate),
                                          frequency(frequency) {
